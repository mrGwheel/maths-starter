...
function togglePauseResume() {
  console.log("Pause button clicked. Current state:", isPaused); // Debugging

  if (isPaused) {
    // Resume the game
    pauseButton.textContent = "⏸"; // Change to pause icon
    ...
    pauseButton.textContent = "▶"; // Change to play icon
...
resetButton.addEventListener("click", () => {
  ...
  quitModal.style.display = "block"; // Show the modal
});
...
function resetGame() {
  ...
  isPaused = false;
  pauseButton.textContent = "⏸"; // Reset button text to pause
}
